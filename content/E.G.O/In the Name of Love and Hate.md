...
><span class="icon waw">In the Name of Love and Hate</span>
...
When she tried to rectify it, everything was over.
>|  Details |  | 
> | --- | --- |
> | Type | Special |
> | Attack Speed | <span class="no-icon resistant">Very Fast</span> |
> | Cost | 70 <span class="icon pe">PE</span> | 
> | Requirements | <span class="icon rank4">Agent Level 4</span>; <span class="icon fort">Fortitude Level 3</span>; <span class="icon just">Justice Level 3</span> |
>
...
> >
>
> >[!default] With Love! / Get out of my head...
> >
> > A smack from the wand, but it can alternatively shoot.
...
> >
>
> >[!default] Arcana Beats!! / Reversed Arcana Slave (Requires E.G.O Suit)
> >
...
> | Requirements | <span class="icon rank4">Agent Level 4</span>; <span class="icon prud">Prudence Level 4</span>; <span class="icon temp">Temperance Level 3</span> |
> 
...
> | :---: | :---: | :---: | :---: |
>  | <span class="no-icon endured">Endured (0.7)</span> | <span class="no-icon endured">Endured (0.8)</span> | <span class="no-icon resistant">Resistant (0.4)</span> | <span class="no-icon vulnerable">Vulnerable (2.0)</span> |
>
...
>[!default] Gift: In the Name of Love and Hate
>A cute little heart hairclip
>|  Benefits | Slot: Hat | 
> | --- | :---: |
> | <span class="icon wrkscc">Success Rate</span> +2; <span class="icon wrkspd">Work Speed</span> +2; <span class="icon spd">Movement Speed</span> +4; <span class="icon atkspd">Attack Speed</span> +4 |  |

>[!default] Gift: In the Name of Hate
>Two small wings that resemble the ones Queen of Hatred has in her serpent form. The wings increase in size if they're in a Hysteric state. This gift can only be obtained by the employee wearing In the Name of Love and Hate. It is obtained when said employee deals the most damage against Queen of Hatred when she is breached.
>|  Benefits | Slot: Left & Right Back | 
> | --- | :---: |
> | This gift only activates when the wearer is in the <span class="icon warn2">Regressive Transformation - Reversed</span> state: <span class="icon spd">Movement Speed</span> +10; <span class="icon atkspd">Attack Speed</span> +10; When gaining <span class="icon warn4">Love/Hate</span>, gain 2 additional count; deal <span class="icon weap">+25% damage</span> when using 'Reversed Arcana Slave' |  |
